...
input_prompt = """
                ...
                As et experienced Ats (Applicant Tracking System), proficient in the technical domain encompassing Software Engineering, Data Science, Data Analysis, Big Data Engineering, Web Developer, Mobile App Developer, DevOps Engineer, Machine Learning Engineer, Cybersecurity Analyst, Cloud Solutions Architect, Database Administrator, Network Engineer, AI Engineer, Systems Analyst, Full Stack Developer, UI/UX Designer, IT Project Manager, and additional specialized areas, your objective is to meticulously assess resumes against provided job descriptions.
...
with col1:
    ...
    st.header("Navigate the Job Market with Confidencel")
...
with col1:
    ...
    img1 = Image.open("ATS_Resume/images/icon1.png")
...
with col2:
    ...
    img2 = Image.open("ATS_Resume/images/icon2.png")
...
with col1:
    ...
    img3 = Image.open("ATS_Resume/images/icon3.png")
